...
?>
	...
	<section class="member-details section screen" data-anchor="members-details">
     ...
     <div class="donations section screen" data-anchor="donations">
     <div class="carousel">
		<div class="donations-details__title slide">
			<div class="container">
                ...
                <div class="grid js-add-member-content">	
                    <div class="whole">
                        <h4 class="p-title d-title">Tank Tread Belt</h4>
                        <p class="p--smaller">
        ...
        <div class="donations-details__title slide">
			<div class="container">
                ...
                <div class="grid js-add-member-content">	
                    <div class="whole">
                        <h4 class="p-title d-title">Tank Tread Belt 2</h4>
                        <p class="p--smaller">
                            Tank Tread Belt Specs 2
                        </p>
                    </div>
